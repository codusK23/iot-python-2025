...
- 파이썬 응용
    - 토이프로젝트
        - 내 영화 앱 수정, 마무리
            - 예외처리 : 입력시 바로 엔터, 입력시 4개의 아이템을 입력하지 않을 때
            - 화면편집 : 검색이나 출력시 데이터 수 표시
            
https://github.com/user-attachments/assets/416a6b22-1642-449d-9d28-7012110c79d6
...
- 파이썬 응용
    ...
    - Tkinter 학습
        ...
        ```
<!-- 주석 -->
<!-- html에서 사용하는 <img> 태그로 캡처한 이미지 추가 -->
...
https://github.com/user-attachments/assets/eab9c9f9-d8dc-47fd-9f1b-af3a72556ee6
...
<img src="./image/py004.png" width="700" height="450">